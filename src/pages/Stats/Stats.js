...
export default class Stats extends Component {
  constructor(props) {
    ...
    this.updateRegisteredUserHistory = this.updateRegisteredUserHistory.bind(
      this
    );
  ...
  updateRegisteredUserHistory(newInterval) {
    ...
    if (newInterval) time_period_days = parseInt(newInterval);
