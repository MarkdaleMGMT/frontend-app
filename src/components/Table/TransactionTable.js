...
export default class TransactionTable extends Component {
  ...
  handleChange = e => {
    ...
    if (name == "entries") value = parseInt(value);
  ...
  render() {
    ...
    const columns = [
      ...
      {
        Header: "Description",
        accessor: mask ? "transaction_type" : "description"
      },
      {
        id: "amount",
        Header: "Amount",
                ...
                <div>
                  <form className="form-inline">
                    ...
                    <select
                      name="entries"
                      style={{ width: "auto" }}
                      className="custom-select my-1 mr-sm-2 transaction-select-control"
                      value={entries}
                ...
                <div className="search-container">
                  <div className="form-group">
                    ...
                    <input
                      name="search"
                      style={{ width: "100%" }}
                      className="form-control trasaction-input-control"
                      placeholder="Search"
